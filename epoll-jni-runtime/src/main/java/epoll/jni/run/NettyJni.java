...
{
    public static void registerJni(Effects effects)
    {
    ...
    public static final class Effects
    {
        ...
        public Effects(Consumer<Class<?>> registerClass, Consumer<Field> registerField, Consumer<Executable> registerMethod) {
