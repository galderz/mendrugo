...
```bash
cd ~/quarkus && ./mvnw install -DskipTests -DskipDocs -Dquickly -Dinvoker.skip -DskipExtensionValidation -Dskip.gradle.tests -Dskip.gradle.build -Dtruststore.skip -Dinsecure.repositories=WARN
```
