...
${native_image} \
    ...
    --initialize-at-run-time=io.vertx.mutiny.core.http.HttpHeaders \
    ...
    --initialize-at-run-time=io.vertx.core.http.HttpHeaders \
    ...
    --initialize-at-run-time=io.vertx.ext.web.impl.ForwardedParser \
    --initialize-at-run-time=io.netty.handler.pcap.PcapWriteHandler\$WildcardAddressHolder \
    --initialize-at-run-time=io.netty.handler.codec.CharSequenceValueConverter \
